# CONTEXT — hello-world-react-app-bindings

Orientation for contributors to this **React + Vite + bindings** Hello World
...
index.html
src/
  App.tsx                        ← hero, DOC_LINKS, <BindingsStatus />
  main.tsx
...
- **Bindings status cards:** `src/components/BindingsStatus.tsx`
